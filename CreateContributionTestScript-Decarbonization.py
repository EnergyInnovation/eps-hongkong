...
PotentialPolicies = (
	...
	(True,"Reduce EV Range Anxiety and Charging Time","Electric Vehicle Range n Charging Time",[0,0.5],"EV Range n Charging Time"),
	...
	(True,"Additional Minimum Required EV Sales Percentage[passenger,motorbikes]","Electric Vehicle Sales Mandate - Passenger Motorbikes",[0,1],"EV Sales Mandate"),
	(True,"Additional Minimum Required EV Sales Percentage[freight,motorbikes]","Electric Vehicle Sales Mandate - Freight Motorbikes",[0,1],"EV Sales Mandate"),
	...
	(True,"Percentage Additional Improvement of Fuel Economy Std[passenger,LDVs]","Fuel Economy Standard - Passenger LDVs",[0,0.3],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[freight,LDVs]","Fuel Economy Standard - Freight LDVs",[0,0.3],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[passenger,HDVs]","Fuel Economy Standard - Passenger HDVs",[0,0.3],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[freight,HDVs]","Fuel Economy Standard - Freight HDVs",[0,0.3],"Vehicle Fuel Economy Standards"),
	...
	(True,"Percentage Additional Improvement of Fuel Economy Std[passenger,motorbikes]","Fuel Economy Standard - Passenger Motorbikes",[0,0.3],"Vehicle Fuel Economy Standards"),
	(True,"Percentage Additional Improvement of Fuel Economy Std[freight,motorbikes]","Fuel Economy Standard - Freight Motorbikes",[0,0.3],"Vehicle Fuel Economy Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,urban residential]","Building Energy Efficiency Standards - Urban Residential Cooling and Ventilation",[0,0.4],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,urban residential]","Building Energy Efficiency Standards - Urban Residential Envelope",[0,0.3],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,urban residential]","Building Energy Efficiency Standards - Urban Residential Appliances",[0,0.25],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,rural residential]","Building Energy Efficiency Standards - Rural Residential Cooling and Ventilation",[0,0.4],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,rural residential]","Building Energy Efficiency Standards - Rural Residential Envelope",[0,0.3],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,rural residential]","Building Energy Efficiency Standards - Rural Residential Appliances",[0,0.25],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[cooling and ventilation,commercial]","Building Energy Efficiency Standards - Commercial Cooling and Ventilation",[0,0.4],"Building Energy Efficiency Standards"),
	(True,"Reduction in E Use Allowed by Component Eff Std[envelope,commercial]","Building Energy Efficiency Standards - Commercial Envelope",[0,0.3],"Building Energy Efficiency Standards"),
	...
	(True,"Reduction in E Use Allowed by Component Eff Std[appliances,commercial]","Building Energy Efficiency Standards - Commercial Appliances",[0,0.25],"Building Energy Efficiency Standards"),
	...
	(True,"Share of Preexisting Buildings Subject to Retrofitting[urban residential]","Retrofit Existing Buildings - Urban Residential",[0,0.48],"Increased Retrofitting"),
	(True,"Share of Preexisting Buildings Subject to Retrofitting[rural residential]","Retrofit Existing Buildings - Rural Residential",[0,0.48],"Increased Retrofitting"),
	(True,"Share of Preexisting Buildings Subject to Retrofitting[commercial]","Retrofit Existing Buildings - Commercial",[0,0.48],"Increased Retrofitting"),
	...
	(True,"Renewable Portfolio Std Percentage","Carbon-free Electricity Standard",[0,0.1],"Carbon-free Electricity Standard"),
	(False,"Percent Change in Electricity Exports","Change Electricity Exports",[-0.5,1],"Electricity Imports and Exports"),
	(True,"Percent Change in Electricity Imports","Change Electricity Imports",[0,0.8],"Electricity Imports and Exports"),
	...
	(True,"Percentage Improvement in Eqpt Efficiency Standards above BAU[other industries]","Industry Energy Efficiency Standards - Other Industries",[0,0.3],"Industry Energy Efficiency Standards"),
	...
	(True,"Fraction of Potential Additional CCS Achieved","Carbon Capture and Sequestration",[0,0.9],"Carbon Capture and Sequestration"),
